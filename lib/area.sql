/**
 * 县及县以上行政区划代码（截止2013年8月31日
 * 来源：国家统计局发布时间：2014-01-17 15:04
 * by oTwo 2014年4月28日 10:09:10
 */
/*
...
CREATE TABLE `area` (
  `code` varchar(255) COLLATE utf8_bin NOT NULL COMMENT '行政编码',
  `name` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '行政区名',
  `pCode` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT '父级行政编码,与code进行关联',
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='县及县以上行政区划代码（截止2013年8月31日）\r\n来源：国家统计局发布时间：2014-01-17 15:04';

-- ----------------------------
-- Records of area
-- ----------------------------
INSERT INTO `area` VALUES ('86', '中国', 'root'),
('110000', '北京市', '86'),
('110100', '市辖区', '110000'),
('110101', '东城区', '110100'),
('110102', '西城区', '110100'),
